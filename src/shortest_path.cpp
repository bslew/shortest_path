...
//                 "include path")
			("obst", po::value<string>()->default_value(""), "Obstacles file (space separated x,y integer coordinates.")
...
//					"Azimuth from south westwards")
		    ("algo", po::value<string>()->default_value("dijkstra"), "select algorithm."
		    		"For now only dijkstra is possible")
			
		    ("x", po::value<int>()->default_value(0), "x start")
		    ("y", po::value<int>()->default_value(0), "y start")
		    ("xf", po::value<int>()->default_value(0), "x end")
		    ("yf", po::value<int>()->default_value(0), "y end")
		    ("field_xmin", po::value<int>()->default_value(0), "minimal x coordinate of the field")
		    ("field_ymin", po::value<int>()->default_value(0), "minimal y coordinate of the field")
		    ("field_xmax", po::value<int>()->default_value(0), "maximal x coordinate of the field")
		    ("field_ymax", po::value<int>()->default_value(0), "maximal y coordinate of the field")
        ...
        po::options_description visible("test\n\n "
    			"This program ... "
    			"\n\n. "
    			"\n"
        ...
        if (!ifs) {
            cerr << "cannot open config file: " << config_file << " (ignoring)\n";
//            return 0;
        }
        else {
